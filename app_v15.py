...
from voice_v15 import LocalWhisper, LunaVoiceOutput
from memory import LunaMemory
from actions_v15 import execute_action, get_due_reminders
from personality_v15 import PERSONALITY, recent_user_recall, style_instruction
...
class LunaApp:
    ...
    def __init__(self, root):
        ...
        self.speed_choice = tk.StringVar(value="Gentle")
        self.style_choice = tk.StringVar(value="Sweet")
    ...
    def build_interface(self):
        ...
        style_menu = tk.OptionMenu(
            ...
            "Sweet", "Playful", "Calm", "Focused", command=self.change_style
        )
        ...
        self.stop_speaking_button = tk.Button(
            buttons, text="STOP SPEAKING", command=self.stop_speaking,
            font=("Segoe UI", 9, "bold"), bg="#0C4051", fg="white",
            activebackground="#11647C", activeforeground="white",
            relief="flat", cursor="hand2"
        )
        self.stop_speaking_button.pack(side="left", fill="x", expand=True, ipady=7, padx=(4, 0))
